...
create_symlink "$AI_LIB_PATH/pi_settings_helpers.sh" "$LIB_DIR/pi_settings_helpers.sh"
create_symlink "$AI_LIB_PATH/install_pi_settings.sh" "$LIB_DIR/install_pi_settings.sh"
create_symlink "$AI_LIB_PATH/uninstall_pi_settings.sh" "$LIB_DIR/uninstall_pi_settings.sh"
