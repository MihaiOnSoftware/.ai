...
4. **Present your plan**: Format like the examples below, with clear slices, goals, implementation steps, and tests.
...
### 7. Acknowledge Untestable Slices
...
**E - Estimable**: Can estimate how long it will take. If you can't estimate, slice is too vague or depends on unknown complexity.
...
- ✅ Estimable: 30-45 minutes based on similar work
...
**The goal**: Someone else should be able to implement slice 1 without reading slice 2. Each slice should feel like a complete mini-project that delivers value.
